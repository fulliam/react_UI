      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              <button className="table-btn" onClick={() => setIsOpenBasic(true)}>
                Открыть
              </button>
              <Modal
                isOpen={isOpenBasic}
          ...
          <tr>
            ...
            <td>
              <button className="table-btn" onClick={() => setIsOpenNoOverlay(true)}>
                Открыть
              </button>
              <Modal
          ...
          <tr>
            ...
            <td>
              <button className="table-btn" onClick={() => setIsOpenNested(true)}>
                Открыть
              </button>
              <Modal
                isOpen={isOpenNested}
          ...
          <tr>
            ...
            <td>
              <button className="table-btn" onClick={() => setIsOpenTopRight(true)}>
                Открыть
              </button>
              <Modal
